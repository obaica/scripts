...
#
#  If you find this script useful, please send us a note.
#  Right now we do not have a publication with it but we 
#  expect to have one.
#
#  Check the web page once in a while, we are working in a tutorial that could help you.
#  
...
def scriptFermi2D(args):
  ...
  fs = FermiSurface(symm.kpoints, symm.bands-args.fermi, symm.character,
                    loglevel=loglevel)
